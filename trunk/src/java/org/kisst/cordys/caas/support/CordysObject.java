...
public abstract class CordysObject implements Comparable<CordysObject>
{
    ...
    public Props<Object> getProps()
    {
        return new Props<Object>(this, null);
    }

    public static void log(String msg)
    {
        Environment.debug(msg);
    }
    ...
    public Differences deepdiff(CordysObject other)
    {
        return diff(other, 100);
    }

    public Differences diff(CordysObject other)
    {
        return diff(other, 0);
    }

    public Differences diff(CordysObject other, int depth)
    {
        return diff(null, other, depth);
    }

    public Differences diff(Differences parent, CordysObject other, int depth)
    {
        if (this.getClass() != other.getClass())
            throw new RuntimeException("Cannot diff two different classes " + this.getClass().getName() + " and "
        ...
        {
            if (key.equals("dn") || key.equals("key") || key.equals("parent") || key.equals("system") || key.equals("varName"))
                continue;
