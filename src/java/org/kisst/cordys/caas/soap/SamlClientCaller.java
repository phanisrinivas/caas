...
public class SamlClientCaller extends BaseCaller {
	...
	/**
	 * Delegates the input SOAP request to sendHttpRequest
	 */
	...
	/**
	 * Sends the input SOAP request to the Cordys gateway after adding SAML
	 * Artifact Id and other query string parameters
	 * 
	 * @param url - Cordys BaseGateway URL
	 * @param inputSoapRequest - SOAP Request XML string
	 * @param nvPairList - List of NameValuePair objects that contain the name and the
	 *            			value of the query string parameters
