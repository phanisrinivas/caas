...
public class ServiceContainer extends LdapObjectBase 
{
	...
	{ 
		super.myclear(); workerprocess=null; 
	} 
	...
	/**
	 * Creates a connection point for this service container with the given name and on the
	 * given machine
	 * 
	 * @param name Connection point name
	...
	/**
	 * Creates a connection point for this service container with the given name, type on
	 * the given machine
	 * 
	 * @param name Connection point name
