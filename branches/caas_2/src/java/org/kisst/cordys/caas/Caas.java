...
public class Caas 
{
	...
	/**
	 * Constructs a Cordys system and caches it. Depending up on the authentication mechanism mentioned 
	 * in the caas.conf file it connects to the Cordys server and returns an instance of CordysSystem
	 * It also loads the properties file of the system if configured
	 * 
	 * @param name
	 * @return
	 */
